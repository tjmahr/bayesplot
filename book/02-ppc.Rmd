...
## Fitting some example models

To demonstrate some of the various PPCs that can be created with the
__bayesplot__ package we'll use an example of comparing Poisson and Negative
...
Data_](https://CRAN.R-project.org/package=rstanarm/vignettes/count.html) (Gabry
and Goodrich, 2017).
